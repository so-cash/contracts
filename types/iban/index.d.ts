 ...
 * Cyril Schumacher
 *
 * Attention, modified version compare to source by Guénolé de Cadoudal as the declare module 'iban' was not present preventing it to be recognized
 */
...
declare module "iban" {
  ...
  interface IBANStatic {
     ...
     */
    countries: Record<Specification["countryCode"], Specification>;
