...
// this import is required to ensure compiler optinization does not ignore this contract
...
contract CountryReferentialDiamond is IDiamondBase, DiamondBase, DiamondWritableInternal {
    constructor(
...
contract CountryReferentialDiamondReadable is DiamondReadable {
}

contract CountryReferentialDiamondWritable is InitializableInternal, DiamondWritableInternal {
    function initialize(bytes2 countryCode) external initializer {
      OwnableStorage.__init(msg.sender);
      CountryStateStorage.__init(countryCode);
    }
