...
library IBANCalculator {
    ...
    * accountNumber will be a 11 digit string defined when the account is attached to the CommercialBankCash contract
     */
    function calculateFrenchIBAN(string memory country2, string memory bankCode5, string memory branchCode5, string memory accountNumber11) public pure returns (string memory) {
    ...
    function extractFrenchIBAN(string memory iban) public pure returns (bool valid, string memory country, string memory bankCode5, string memory branchCode5, string memory accountNumber11, uint16 ribKey) {
